 ...
 * @Vich\Uploadable
 * @UniqueEntity("name", message="le nom que vous choisissez existe, merci de choisir un autre")
 */
class Company
{
    /**
    ...
    /**
     * @var File
     * @Vich\UploadableField (mapping="company_image", fileNameProperty="logo")
     */
    private $imageFile;
