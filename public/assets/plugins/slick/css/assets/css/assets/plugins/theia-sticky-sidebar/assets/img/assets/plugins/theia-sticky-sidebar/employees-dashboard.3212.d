...
<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/css/assets/plugins/theia-sticky-sidebar/assets/img/assets/plugins/theia-sticky-sidebar/employees-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 02:36:18 GMT -->
<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/x-icon" href="assets/favicon.31ff.delaye">
		
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="as/bootstrap.min.3200.dela">
		
		<!-- Linearicon Font -->
		<link rel="stylesheet" href="asset/lnr-icon.3201.delaye">
				
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="as/font-awesome.min.3202.d">
		
		<!-- Custom CSS -->
		<link rel="stylesheet" href="assets/c/style.3203.delaye">
	...
	<body>
						...
						<div class="row align-items-center">
							<div class="col-lg-3 col-md-3 col-sm-3 col-6">
								<div class="logo my-3 my-sm-0">
									<a href="index.html">
										<img src="assets/im/logo.3205.delaye" alt="logo image" class="img-fluid" width="100">
									</a>
								</div>
							</div>
											...
											<div class="user-info align-right dropdown d-inline-block header-dropdown">
												<a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
													<div class="user-avatar d-inline-block">
														<img src="assets/i/img-6.3207.delaye" alt="user avatar" class="rounded-circle img-fluid" width="55">
													</div>
												</a>
								...
								<div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
									<div class="user-info card-body">
										<div class="user-avatar mb-4">
											<img src="assets//img-13.3211.delaye" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										</div>
							...
							<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card grow">
									<div class="card-body">
										<ul class="list-group list-group-horizontal-lg">
											...
											<li class="list-group-item text-center button-6"><a class="text-dark" href="employees-dashboard.3212.d">Employees Dashboard</a></li>
										</ul>
									</div>
								</div>
							<!-- Widget -->
											...
											<div class="recent-comment">
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="assets/i/img-9.3213.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="assets/i/img-5.3214.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="assets/i/img-6.3207.delaye" alt="Maria Cotton"></div>
														</div>
													</div>
												</a>
											</div>
									...
									<div class="card flex-fill team-lead shadow-sm grow">
										...
										<div class="card-body">
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="assets/i/img-6.3207.delaye" alt="Maria Cotton" class="img-fluid"></div>
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="assets/i/img-5.3214.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="assets/i/img-4.3215.delaye" alt="Linda Craver" class="img-fluid"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="assets/i/img-3.3216.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media">
												<div class="e-avatar avatar-offline mr-3"><img class="img-fluid" src="assets/i/img-2.3217.delaye" alt="Linda Craver"></div>
												<div class="media-body">
										...
										<div class="card-body recent-activ admin-activ">
											<div class="recent-comment">
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="assets/i/img-5.3214.delaye" alt="Danny Ward"></div>
													</div>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="assets/i/img-2.3217.delaye" alt="John Gibbs"></div>
													</div>
													<div class="notice-body">
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="assets/i/img-6.3207.delaye" alt="Maria Cotton"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="assets/i/img-4.3215.delaye" alt="Linda Craver"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="assets/i/img-3.3216.delaye" alt="Jenni Sims"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
		...
		<!-- jQuery -->
		<script src="as/jquery-3.2.1.min.3218.d"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="ass/popper.min.3219.delaye"></script>
		<script src="as/bootstrap.min.321a.dela"></script>
				
		<!-- Chart JS -->
		<script src="asse/Chart.min.321b.delaye"></script>
		<script src="assets/j/chart.321c.delaye"></script>
		
		<!-- Sticky sidebar JS -->
		<script src="as/ResizeSensor.321d.delay"></script>		
		<script src="as/theia-sticky-sidebar.32"></script>		
			
		<!-- Custom Js -->
		<script src="assets//script.321f.delaye"></script>
