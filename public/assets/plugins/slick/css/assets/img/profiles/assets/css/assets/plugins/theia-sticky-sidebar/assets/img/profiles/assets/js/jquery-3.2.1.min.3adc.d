...
<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/profiles/assets/css/assets/plugins/theia-sticky-sidebar/assets/img/profiles/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 04:35:18 GMT -->
<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/x-icon" href="as/favicon.124db.delaye">
		
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="bootstrap.min.124dc.del">
		
		<!-- Linearicon Font -->
		<link rel="stylesheet" href="a/lnr-icon.124dd.delaye">
				
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="font-awesome.min.124de">
		
		<!-- Custom CSS -->
		<link rel="stylesheet" href="asse/style.124df.delaye">
	...
	<body>
						...
						<div class="row align-items-center">
							<div class="col-lg-3 col-md-3 col-sm-3 col-6">
								<div class="logo my-3 my-sm-0">
									<a href="index.html">
										<img src="asset/logo.124e1.delaye" alt="logo image" class="img-fluid" width="100">
									</a>
								</div>
							</div>
											...
											<div class="user-info align-right dropdown d-inline-block header-dropdown">
												<a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
													<div class="user-avatar d-inline-block">
														<img src="asse/img-6.124e3.delaye" alt="user avatar" class="rounded-circle img-fluid" width="55">
													</div>
												</a>
												
												<!-- Notifications -->
												<div class="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
													<a class="dropdown-item p-2" href="employment.124e4.delaye">
								...
								<div class="d-block d-lg-none">
									...
									<div class="offcanvas-menu" id="offcanvas_menu">
										...
										<div class="user-menu-items px-3 m-0">
											...
											<a class="p-2" href="employment.124e4.delaye">
												<span class="media align-items-center">
													<span class="lnr lnr-user mr-3"></span>
													<span class="media-body text-truncate text-left">
								...
								<div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
									<div class="user-info card-body">
										<div class="user-avatar mb-4">
											<img src="ass/img-13.124ed.delaye" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										</div>
									...
									<div class="card ctm-border-radius shadow-sm border-none grow">
										<div class="card-body">
											<div class="row no-gutters">
												...
												<div class="col-6 align-items-center shadow-none text-center">											
													<a href="employment.124e4.delaye" class="text-dark p-4 last-slider-btn ctm-border-right"><span class="lnr lnr-user pr-0 pb-lg-2 font-23"></span><span class="">Profile</span></a>												
												</div>
											</div>
										</div>
									</div>
											...
											<div class="recent-comment">
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-9.124ef.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-5.124f0.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-6.124e3.delaye" alt="Maria Cotton"></div>
														</div>
													</div>
												</a>
											</div>
									...
									<div class="card flex-fill team-lead shadow-sm grow">
										...
										<div class="card-body">
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asse/img-6.124e3.delaye" alt="Maria Cotton" class="img-fluid"></div>
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asse/img-5.124f0.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asse/img-4.124f1.delaye" alt="Linda Craver" class="img-fluid"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asse/img-3.124f2.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media">
												<div class="e-avatar avatar-offline mr-3"><img class="img-fluid" src="asse/img-2.124f3.delaye" alt="Linda Craver"></div>
												<div class="media-body">
										...
										<div class="card-body recent-activ admin-activ">
											<div class="recent-comment">
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-5.124f0.delaye" alt="Danny Ward"></div>
													</div>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-2.124f3.delaye" alt="John Gibbs"></div>
													</div>
													<div class="notice-body">
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-6.124e3.delaye" alt="Maria Cotton"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-4.124f1.delaye" alt="Linda Craver"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-3.124f2.delaye" alt="Jenni Sims"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
		...
		<!-- jQuery -->
		<script src="jquery-3.2.1.min.124f4"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="popper.min.124f5.delaye"></script>
		<script src="bootstrap.min.124f6.del"></script>
				
		<!-- Chart JS -->
		<script src="/Chart.min.124f7.delaye"></script>
		<script src="asse/chart.124f8.delaye"></script>
		
		<!-- Sticky sidebar JS -->
		<script src="ResizeSensor.124f9.dela"></script>		
		<script src="theia-sticky-sidebar.12"></script>		
			
		<!-- Custom Js -->
		<script src="ass/script.124fb.delaye"></script>
		
	</body>

<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/profiles/assets/css/assets/plugins/theia-sticky-sidebar/assets/img/profiles/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 04:35:29 GMT -->
</html>