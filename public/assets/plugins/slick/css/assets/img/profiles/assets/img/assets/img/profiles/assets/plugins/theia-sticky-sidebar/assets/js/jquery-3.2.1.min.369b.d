...
<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/profiles/assets/img/assets/img/profiles/assets/plugins/theia-sticky-sidebar/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 03:33:01 GMT -->
<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/x-icon" href="as/favicon.10f96.delaye">
		
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="bootstrap.min.10f97.del">
		
		<!-- Linearicon Font -->
		<link rel="stylesheet" href="a/lnr-icon.10f98.delaye">
				
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="font-awesome.min.10f99">
		
		<!-- Custom CSS -->
		<link rel="stylesheet" href="asse/style.10f9a.delaye">
	...
	<body>
						...
						<div class="row align-items-center">
							<div class="col-lg-3 col-md-3 col-sm-3 col-6">
								<div class="logo my-3 my-sm-0">
									<a href="index.html">
										<img src="asset/logo.10f9c.delaye" alt="logo image" class="img-fluid" width="100">
									</a>
								</div>
							</div>
											...
											<div class="user-info align-right dropdown d-inline-block header-dropdown">
												<a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
													<div class="user-avatar d-inline-block">
														<img src="asse/img-6.10f9e.delaye" alt="user avatar" class="rounded-circle img-fluid" width="55">
													</div>
												</a>
												
												<!-- Notifications -->
												<div class="dropdown-menu notification-dropdown-menu shadow-lg border-0 p-3 m-0 dropdown-menu-right">
													<a class="dropdown-item p-2" href="employment.10f9f.delaye">
								...
								<div class="d-block d-lg-none">
									...
									<div class="offcanvas-menu" id="offcanvas_menu">
										...
										<div class="user-menu-items px-3 m-0">
											...
											<a class="p-2" href="employment.10f9f.delaye">
												<span class="media align-items-center">
													<span class="lnr lnr-user mr-3"></span>
													<span class="media-body text-truncate text-left">
								...
								<div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
									<div class="user-info card-body">
										<div class="user-avatar mb-4">
											<img src="ass/img-13.10fa8.delaye" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										</div>
									...
									<div class="card ctm-border-radius shadow-sm border-none grow">
										<div class="card-body">
											<div class="row no-gutters">
												...
												<div class="col-6 align-items-center shadow-none text-center">											
													<a href="employment.10f9f.delaye" class="text-dark p-4 last-slider-btn ctm-border-right"><span class="lnr lnr-user pr-0 pb-lg-2 font-23"></span><span class="">Profile</span></a>												
												</div>
											</div>
										</div>
									</div>
											...
											<div class="recent-comment">
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-9.10faa.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-5.10fab.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asse/img-6.10f9e.delaye" alt="Maria Cotton"></div>
														</div>
													</div>
												</a>
											</div>
									...
									<div class="card flex-fill team-lead shadow-sm grow">
										...
										<div class="card-body">
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asse/img-6.10f9e.delaye" alt="Maria Cotton" class="img-fluid"></div>
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asse/img-5.10fab.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asse/img-4.10fac.delaye" alt="Linda Craver" class="img-fluid"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asse/img-3.10fad.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media">
												<div class="e-avatar avatar-offline mr-3"><img class="img-fluid" src="asse/img-2.10fae.delaye" alt="Linda Craver"></div>
												<div class="media-body">
										...
										<div class="card-body recent-activ admin-activ">
											<div class="recent-comment">
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-5.10fab.delaye" alt="Danny Ward"></div>
													</div>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-2.10fae.delaye" alt="John Gibbs"></div>
													</div>
													<div class="notice-body">
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-6.10f9e.delaye" alt="Maria Cotton"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-4.10fac.delaye" alt="Linda Craver"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asse/img-3.10fad.delaye" alt="Jenni Sims"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
		...
		<!-- jQuery -->
		<script src="jquery-3.2.1.min.10faf"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="popper.min.10fb0.delaye"></script>
		<script src="bootstrap.min.10fb1.del"></script>
				
		<!-- Chart JS -->
		<script src="/Chart.min.10fb2.delaye"></script>
		<script src="asse/chart.10fb3.delaye"></script>
		
		<!-- Sticky sidebar JS -->
		<script src="ResizeSensor.10fb4.dela"></script>		
		<script src="theia-sticky-sidebar.10"></script>		
			
		<!-- Custom Js -->
		<script src="ass/script.10fb6.delaye"></script>
		
	</body>

<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/profiles/assets/img/assets/img/profiles/assets/plugins/theia-sticky-sidebar/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 03:33:12 GMT -->
</html>