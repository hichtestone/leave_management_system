...
<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/assets/img/profiles/assets/plugins/theia-sticky-sidebar/assets/img/profiles/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Apr 2021 21:17:21 GMT -->
<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/x-icon" href="ass/favicon.93d6.delaye">
		
		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="bootstrap.min.93d7.dela">
		
		<!-- Linearicon Font -->
		<link rel="stylesheet" href="as/lnr-icon.93d8.delaye">
				
		<!-- Fontawesome CSS -->
        <link rel="stylesheet" href="font-awesome.min.93d9.d">
		
		<!-- Custom CSS -->
		<link rel="stylesheet" href="asset/style.93da.delaye">
	...
	<body>
						...
						<div class="row align-items-center">
							<div class="col-lg-3 col-md-3 col-sm-3 col-6">
								<div class="logo my-3 my-sm-0">
									<a href="index.html">
										<img src="assets/logo.93dc.delaye" alt="logo image" class="img-fluid" width="100">
									</a>
								</div>
							</div>
											...
											<div class="user-info align-right dropdown d-inline-block header-dropdown">
												<a href="javascript:void(0)" data-toggle="dropdown" class=" menu-style dropdown-toggle">
													<div class="user-avatar d-inline-block">
														<img src="asset/img-6.93de.delaye" alt="user avatar" class="rounded-circle img-fluid" width="55">
													</div>
												</a>
								...
								<div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
									<div class="user-info card-body">
										<div class="user-avatar mb-4">
											<img src="asse/img-13.93e8.delaye" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										</div>
							...
							<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card grow">
									<div class="card-body">
										<ul class="list-group list-group-horizontal-lg">
											...
											<li class="list-group-item text-center button-6"><a class="text-dark" href="employees-dashboard.93e">Employees Dashboard</a></li>
										</ul>
									</div>
								</div>
							<!-- Widget -->
											...
											<div class="recent-comment">
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asset/img-9.93ea.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asset/img-5.93eb.delaye" alt="Avatar"></div>
														</div>
													</div>
												</a>
												<hr>
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="asset/img-6.93de.delaye" alt="Maria Cotton"></div>
														</div>
													</div>
												</a>
											</div>
									...
									<div class="card flex-fill team-lead shadow-sm grow">
										...
										<div class="card-body">
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asset/img-6.93de.delaye" alt="Maria Cotton" class="img-fluid"></div>
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asset/img-5.93eb.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img src="asset/img-4.93ec.delaye" alt="Linda Craver" class="img-fluid"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media mb-3">
												<div class="e-avatar avatar-online mr-3"><img class="img-fluid" src="asset/img-3.93ed.delaye" alt="Linda Craver"></div>
												<div class="media-body">
											...
											<hr>
											<div class="media">
												<div class="e-avatar avatar-offline mr-3"><img class="img-fluid" src="asset/img-2.93ee.delaye" alt="Linda Craver"></div>
												<div class="media-body">
										...
										<div class="card-body recent-activ admin-activ">
											<div class="recent-comment">
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asset/img-5.93eb.delaye" alt="Danny Ward"></div>
													</div>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asset/img-2.93ee.delaye" alt="John Gibbs"></div>
													</div>
													<div class="notice-body">
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asset/img-6.93de.delaye" alt="Maria Cotton"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asset/img-4.93ec.delaye" alt="Linda Craver"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
												...
												<div class="notice-board">
													<div class="table-img">
														<div class="e-avatar mr-3"><img class="img-fluid" src="asset/img-3.93ed.delaye" alt="Jenni Sims"></div>
													</div>
													<div class="notice-body">
														<h6 class="mb-0">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam.</h6>
		...
		<!-- jQuery -->
		<script src="jquery-3.2.1.min.93ef.d"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="/popper.min.93f0.delaye"></script>
		<script src="bootstrap.min.93f1.dela"></script>
				
		<!-- Chart JS -->
		<script src="a/Chart.min.93f2.delaye"></script>
		<script src="asset/chart.93f3.delaye"></script>
		
		<!-- Sticky sidebar JS -->
		<script src="ResizeSensor.93f4.delay"></script>		
		<script src="theia-sticky-sidebar.93"></script>		
			
		<!-- Custom Js -->
		<script src="asse/script.93f6.delaye"></script>
		
	</body>

<!-- Mirrored from dleohr.dreamguystech.com/template-2/dleohr-vertical/assets/plugins/slick/css/assets/img/assets/img/profiles/assets/plugins/theia-sticky-sidebar/assets/img/profiles/assets/js/jquery-3.2.1.min.js by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Apr 2021 21:17:33 GMT -->
</html>